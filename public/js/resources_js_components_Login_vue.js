    ...
    login: function login() {
      ...
      axios.post('http://localhost:8000/api/login', {
        ...
        if (error.response.status == 401) {
          ...
          var errorString = '';
          jquery__WEBPACK_IMPORTED_MODULE_0___default().each(error.response.data.errors, function (key, value) {
            errorString += value + "\n";
          });
          _this.error_message = errorString;
        }
      });
    }
  }
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v("Please sign in")]), _vm._v(" "), _vm.error_message ? _c("div", {
    staticClass: "alert alert-danger"
  }, [_vm._v(_vm._s(_vm.error_message))]) : _vm._e(), _vm._v(" "), _c("div", {
    ...
    domProps: {
      checked: Array.isArray(_vm.remember_me) ? _vm._i(_vm.remember_me, "remember_me") > -1 : _vm.remember_me
    },
    on: {
      change: function change($event) {
        ...
        if (Array.isArray($$a)) {
          ...
          if ($$el.checked) {
            ...
            $$i > -1 && (_vm.remember_me = $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
          }
        } else {
          _vm.remember_me = $$c;
        }
